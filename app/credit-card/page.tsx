              ...
              <div className="flex flex-col lg:flex-row lg:space-x-16">
                ...
                <div className="lg:w-1/2 space-y-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    forward-thinking agency, Digital Scouting Africa has the
                    tools you need to shine. Choose the plan that matches your
                    ambitions and unlock opportunities that take you closer to
                    greatness.
                  </p>
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    charge you for future payments in accordance to our terms
                    and conditions.
                  </p>
                </div>
