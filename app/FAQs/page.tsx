...
import { ChevronDown, ChevronUp, HelpCircle, Mail, Sticker } from 'lucide-react';
  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer: 'Digital Scouting Africa is a platform that connects scouts, agents, coaches, and players. We provide a network where talent can showcase skills and scouts can discover emerging players through advanced tools, metrics, and video highlights, all in one place.'
    },
    {
      question: 'Who can join Digital Scouting Africa?',
      answer: 'Our platform is open to professional scouts, licensed agents, qualified coaches, and talented players looking to advance their careers in football.'
    },
    {
      question: 'How can Digital Scouting Africa help my scouting career?',
      answer: 'We provide comprehensive tools and resources to enhance your scouting capabilities, including advanced analytics, video analysis, and networking opportunities.'
    },
    {
      question: 'Is my data secure on Digital Scouting Africa?',
      answer: 'Yes, we implement industry-standard security measures to protect all user data and personal information on our platform.'
    },
    {
      question: 'How do I get started on Digital Scouting Africa?',
      answer: 'Simply sign up for an account, complete your profile, and start exploring our features. Our onboarding process will guide you through each step.'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <button className="text-gray-600 hover:text-gray-900">Essentials</button>
              <button className="text-gray-600 hover:text-gray-900">Dashboards</button>
              <button className="text-gray-600 hover:text-gray-900">Why choose us</button>
          ...
          <div className="md:col-span-1">
            <div className="sticky top-8">
              ...
              <p className="text-gray-600">
                Find out everything you need to know about us from the frequently asked questions!
              </p>
            </div>
          </div>
        ...
        <div className="bg-blue-900 rounded-2xl p-8 md:p-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-blue-200 mb-8">
              Stay in the loop while we send you the best updates from Digital Scouting Africa.
            </p>
