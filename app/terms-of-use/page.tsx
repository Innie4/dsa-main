...
import { ChevronDown, ChevronUp, Shield, Users, Bell, Settings, ExternalLink, Menu, X, Book, UserCheck, AlertTriangle } from 'lucide-react';
...
function App() {
  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      content: 'We may update these terms at any time. Significant changes will be communicated through platform notifications or email. Continued use of Digital Scouting Africa after updates constitutes acceptance of the revised terms.',
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="px-6 py-8">
            ...
            <p className="mb-4 text-lg">
              Welcome to Digital Scouting Africa. By accessing or using our platform, you agree to comply with these Terms of Use. Please read them very carefully and judiciously.
            </p>
