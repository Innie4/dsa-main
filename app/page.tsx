      ...
      <div className="md:px-20 lg:px-20 p-4 bg-white">
        <div className="min-h-screen bg-white">
          ...
          >
            <div className="container mx-auto md:px-4 lg:px-4  md:py-20 lg:py-20 py-10">
              <div className="max-w-2xl">
                ...
                <Link href="/signup">
                  <button className="bg-[#F7BF56] hover:bg-[#fab942] text-black px-6 py-3 rounded-lg flex space-x-1 font-medium items-center justify-center ml-12">
                    <p>Get Started </p>
                    <img
                      className="h-6 w-6"
                      src="./arrow-side.png"
          ...
          >
            <div className="container mx-auto px-4 text-center">
              <p className="text-2xl font-semibold text-black max-w-3xl mx-auto mb-4">
                ...
                and a{" "}
                <span className="text-blue-600">supportive environment</span>{" "}
                for players of every age group.
              </p>
              <p className="text-lg text-gray-700 max-w-2xl mx-auto">
                We empower players with expert scouting, personalized support,
                and data-driven insights to unlock their full potential.
              </p>
            </div>
          </section>
          ...
          <section className="bg-white py-10 w-full overflow-hidden">
            <h2 className="text-3xl font-bold text-[#122483] mb-8">
              Our Reach
            </h2>
        ...
        <div className="md:px-20 lg:px-20 p-4">
          <div className="flex flex-col md:flex-row bg-white p-6 md:p-10 rounded-xl mx-auto">
            ...
            <div className="md:w-1/2 mt-6 md:mt-0 md:ml-6 space-y-4">
              ...
              <h2 className="text-2xl font-bold text-[#122483]">
                Oluwa Powers
              </h2>
              ...
              <p className="text-gray-400 text-base leading-relaxed">
                A creative playmaker with an eye for passes, Oluwa has an 85%
                pass accuracy rate and is known for his agility on the field. He
                led his team to the finals with 10 assists this season.
              </p>

              <h3 className="text-3xl font-bold text-[#122483]">
                ...in his own words
              </h3>
              ...
              <p className="text-gray-500 italic text-xl leading-relaxed">
                ...
                me stand out on the field. The detailed feedback I received
                showed me areas I hadn&apos;t focused on before, like timing my
                runs and adjusting my positioning to create more opportunities
                for my teammates. This new perspective has not only improved my
                game but also boosted my confidence and determination to push
                myself even further.
              </p>
            </div>
          </div>
          ...
          {/* Testimonials */}
          <div className="bg-white text-black pb-10 space-y-4">
