...
const LandingPage: React.FC = () => {
  return (
    <div className="bg-white">
      <div className="md:px-20 bg-white pb-0 lg:px-20 p-4">
          ...
          <div className="flex flex-col md:flex-row bg-white text-white p-6 md:p-10 rounded-xl mx-auto ">
            ...
            <div className="md:w-1/2 mt-6 md:mt-0 md:ml-6 space-y-4">
              ...
              <p className="text-gray-500 italic">
                ...
                showed me areas I hadn’t focused on before, like timing my runs
                and adjusting my positioning to create more opportunities for my
                teammates. This new perspective has not only improved my game
                but also boosted my confidence and determination to push myself
                even further.
              </p>
            </div>
          </div>
